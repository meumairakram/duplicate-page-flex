...
Description: Duplicate Posts, Pages and Custom Posts using single click. This is a Custom fork of the main plugin which includes action hooks and filters to allow other developers hook their own functions in. 
Author: mndpsingh287 | Umair Akram
Version: 4.4.7
...
if (!defined('DUPLICATE_PAGE_PLUGIN_VERSION')) {
    define('DUPLICATE_PAGE_PLUGIN_VERSION', '4.4.7');
}
            ...
            */
            if (isset($post) && $post != null) {
                ...
                */
                ...
                do_action('duplicate_page_after_post_duplicate', $new_post_id, $post->ID);
